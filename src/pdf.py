...
def createPDF(data,score,dictionary):
    ...
    pdf.cell(70, 7, 'Name', align='C', border = 1)
    pdf.cell(20, 7, 'City', align='C', border = 1)
    pdf.cell(40, 7, 'Price-Night-Euro', align='C', border = 1)
    pdf.cell(25, 7, 'Distance-km', align='C', border = 1)
    pdf.cell(20, 7, 'Score', align='C', border = 1)
    ...
    for i in range(len(data['Name'])):
        ...
        pdf.cell(70, 7, '%s' % (name), align='L', border = 1)
        pdf.cell(20, 7, '%s' % (city), align='C', border = 1)
        pdf.cell(40, 7, '%s' % (price), align='C', border = 1)
        pdf.cell(25, 7, '%s' % (distance), align='C', border = 1)
        pdf.cell(20, 7, '%s' % (score), align='C', border = 1)
